...
async function main(): Promise<void> {
  ...
  const requiredContracts = ['DAOSpaceFactory', 'DecayingTokenFactory'];
  ...
  console.log(
    'Setting spaces contract in DecayingTokenFactory with the following address:',
  );
  ...
  try {
    ...
    await tx.wait();
    console.log('Spaces contract set successfully in DecayingTokenFactory!');
  } catch (error: any) {
