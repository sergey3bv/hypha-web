  ...
  <Select.Root value={value} onValueChange={onValueChange}>
    <Select.Trigger
      className={clsx(
        ...
        {
          'text-violet11 hover:bg-mauve3 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-violet9': variant === 'default',
          'text-sm bg-transparent text-violet9 border-none hover:bg-transparent': variant === 'ghost',
        }
      )}
      aria-label="Food"
    >
